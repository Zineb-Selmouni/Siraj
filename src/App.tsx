 ...
 * éditeur, références, témoignages, passage à l'acte.
 *
 * Les trois dernières forment un bloc : qui nous sommes, qui nous fait
 * confiance, ce qu'ils en disent — puis la demande. Les deux dernières
 * ne s'affichent que si elles ont de quoi s'afficher (voir src/proof.ts).
 *
